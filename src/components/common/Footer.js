            ...
            <footer id="menu-new">
                <button className="iyM5vw Qkd66A ubW6qw fP4ZCw GnpDIA _5RSqIg fFOiLQ" type="button" title="Inicio">
                    <div className="_9wqIaw  TcNIhA">
                        ...
                        <div className="eRxiIQ UXYZvg">{ Translate.parse("HOME") }</div>
                    </div>
                </button>
                <button className="iyM5vw Qkd66A ubW6qw fP4ZCw GnpDIA _5RSqIg fFOiLQ" type="button" title="Pedidos">
                    <div className="footer--item">
                        ...
                        <span className="eRxiIQ UXYZvg">{ Translate.parse("CATCHED 'EM") }</span>
                    </div>
                </button>
                <button
                ...
                >
                    <div className="footer--item">
                        ...
                        <div className="eRxiIQ UXYZvg">{ Translate.parse("SEARCH") }</div>
                    </div>
                </button>
            </footer>
            {/* {toggleSearch && (
